const items = [
    ...
    { name: "(Thanks ChatGPT!)", imageUrl: "images/16-artificial-intelligence.jpg", url: "https://github.com/danbretl/christmas2023", description: "Expressing gratitude to ChatGPT for its assistance. ChatGPT created the website and wrote all the descriptions of the items." },
];
